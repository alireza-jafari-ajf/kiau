...
with st.sidebar:
    ...
    page1 = om(menu_title="The First Article",
                     options=["Articles" , "Entry Data Sets" , "Read Article"],
                     default_index=0,
...
with c1:
    page1_1 = om(menu_title="The First Article",
                         options=["Articles" , "Entry Data Sets" , "The First Article"],
                         default_index=0,
                         #menu_icon="one",
                         icons=["gear" , "folder", "book"],
...
with c2:
    page1_2 = om(menu_title="The Second Article",
                         options=["Articles" , "Entry Data Sets" , "The Second Article"],
                         default_index=0,
                         icons=["gear" , "folder", "book"],
                         orientation="vertical",
                        key="asdjfkjstyfkj",
...
with c3:
    page1_3 = om(menu_title="The Third Article",
                         options=["Articles" , "Entry Data Sets" , "The Third Article"],
                         default_index=0,
                         icons=["gear" , "folder", "book"],
                         orientation="vertical",
                        key="asddftydfgfkj",
...
if page1 == "Entry Data Sets":
    st.switch_page("pages/ED1.py")
if page1_1 == "Entry Data Sets":
    st.switch_page("pages/ED1.py")
